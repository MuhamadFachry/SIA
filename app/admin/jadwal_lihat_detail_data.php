...
<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <a href="jadwal_ubah.php?id=<?php echo $kelas; ?>" class="btn btn-warning"><span class="glyphicon glyphicon-edit"> Ubah</span></a>
                <a href="jadwal_kelas_print.php?id=<?php echo $kelas; ?>" class="btn btn-success "><span class="glyphicon glyphicon-print"> Print</span></a>
