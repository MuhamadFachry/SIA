...
<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <form action="jadwal_tambah_proses.php" method="post">
                    ...
                    for ($i=0; $i <$n ; $i++) { ?>
                      ...
                      <select name="matpel1[]"  class="form-group" required="">
                        ...
                        <?php 
                          ...
                          $query=mysqli_query($koneksi, "select * from matpel_kelas inner join matpel on matpel_kelas.idmatpel=matpel.idmatpel where matpel_kelas.idkelas='$kelas'");
