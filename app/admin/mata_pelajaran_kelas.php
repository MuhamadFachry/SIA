              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="guru_tambah.php">Tambah Guru</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="mata_pelajaran_kelas.php">Mata Pelajaran kelas</a></li>
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <?php include 'mata_pelajaran_kelas_tambah.php'; ?>
                  </div>
          		</div><!-- col-lg-12-->      	
          	</div><!-- /row -->
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <?php include 'mata_pelajaran_kelas_data.php'; ?>
                  </div>
          		</div><!-- col-lg-12-->      	
          	</div><!-- /row -->
