...
<table id="example" class="table table-striped table-bordered table-hover table-condensed">
  ...
  <tbody>
    ...
    $query="select * from jadwal_ujian where status='uts'";
    ...
    while($data=mysqli_fetch_array($hasil)){
      ...
      echo "<td>";
       ...
       <a href='jadwal_uts_hapus.php?id=".$data['idjadwal_ujian']."' class='btn btn-xs btn-danger'><span class='glyphicon glyphicon-trash'></span> Hapus</a>";
