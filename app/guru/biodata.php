...
<?php 
$query=mysqli_query($koneksi,"select *,day(tgl_lahir) as day, month(tgl_lahir) as month,year(tgl_lahir) as year from guru where nip = '".$_SESSION['no_login']."'");
...
<form id=form1  enctype="multipart/form-data"  action="biodata_ubah.php" method="post">
	<div class="col-md-6">
      ...
      <input type="text" name="nipnya" class="form-group" value="<?php echo $data['nip']; ?>" disabled></div>
		</div>
    <div class="row">
