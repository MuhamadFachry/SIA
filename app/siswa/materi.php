...
<html lang="en">
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      <!--sidebar start-->
      <?php 
        $query=mysqli_query($koneksi,"select * from siswa where nis='".$_SESSION['no_login']."'");
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><img src="<?php echo "../../assets/propic/".$data['foto']; ?>" class="img-circle" width="100" height="100"></p>
                  ...
                  <li class="sub-menu">
                      <a href="materi.php"  class="active">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        <li><a href="jadwal_matpel.php">Jadwal Matpel</a></li>
                        <li><a href="jadwal_uas.php">Jadwal UAS</a></li>
                        <li><a href="jadwal_uts.php">Jadwal UTS</a></li>
                      </ul>
