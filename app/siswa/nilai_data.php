            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  ...
                  <h4 style="color: red; ">
                      <?php 
                        ...
                        $cek = mysqli_num_rows($query);
                        if($cek!=0){
                            echo "Nilai anda ada yang kurang dari kkm!";
                        }else{
                ...
                <input type="hidden" name="nis" value="<?php echo $id; ?>">
                    ...
                    <a href="nilai_siswa_print.php?id=<?php echo $id; ?>" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-print"> Print</span></a>
